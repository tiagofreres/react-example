...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(367);

	var _containersApp2 = _interopRequireDefault(_containersApp);

	var _storeConfigureStore = __webpack_require__(374);
	...
	var store = (0, _storeConfigureStore2['default'])(initialState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsProvider = __webpack_require__(350);

	exports.Provider = _interopRequire(_componentsProvider);

	var _componentsConnect = __webpack_require__(352);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStoreShape = __webpack_require__(351);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hoistNonReactStatics = __webpack_require__(365);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCardList = __webpack_require__(368);

	var _componentsCardList2 = _interopRequireDefault(_componentsCardList);

	var _actionsCards = __webpack_require__(371);

	var cardActions = _interopRequireWildcard(_actionsCards);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_componentsCardList2['default'], _extends({ cards: cards }, actions))
	      );
	    }
	  }]);
	...
	App.propTypes = {
	  cards: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	    ...
	    choosed: _react.PropTypes.bool.isRequired,
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    actions: (0, _redux.bindActionCreators)(cardActions, dispatch)
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardList = (function (_Component) {
	  ...
	  _createClass(CardList, [{
	    ...
	    value: function render() {
	      var _props = this.props;
	      var cards = _props.cards;
	      var onSelectCard = _props.onSelectCard;
	      var onChooseCard = _props.onChooseCard;

	      return _react2['default'].createElement(
	        'ul',
	        null,
	        cards.map(function (card) {
	          return _react2['default'].createElement(_Card2['default'], _extends({ key: card.id }, card, { onSelect: onSelectCard, onChoose: onChooseCard }));
	        })
	      );
	    }
	  }]);
	...
	CardList.propTypes = {
	  onSelectCard: _react.PropTypes.func.isRequired,
	  onChooseCard: _react.PropTypes.func.isRequired,
	  cards: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	    selected: _react.PropTypes.bool.isRequired,
	    choosed: _react.PropTypes.bool.isRequired,
	    name: _react.PropTypes.string.isRequired,
	...
	var Card = (function (_Component) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function render() {
	      ...
	      var choosed = _props.choosed;

	      return _react2['default'].createElement(
	        'figure',
	        { className: (selected, choosed) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsCardActionsTypes = __webpack_require__(372);

	var types = _interopRequireWildcard(_constantsCardActionsTypes);

	// https://github.com/insin/redux-action-utils

	var _reduxActionUtils = __webpack_require__(373);

	exports['default'] = {
	  onSelectCard: (0, _reduxActionUtils.actionCreator)(types.SELECT_CARD, 'id'),
	  onChooseCard: (0, _reduxActionUtils.actionCreator)(types.CHOOSE_CARD, 'id')
	};
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	exports.SELECT_CARD = SELECT_CARD;
	var CHOOSE_CARD = 'CHOOSE_CARD';
	exports.CHOOSE_CARD = CHOOSE_CARD;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducers = __webpack_require__(375);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsUpdate = __webpack_require__(377);

	var _reactAddonsUpdate2 = _interopRequireDefault(_reactAddonsUpdate);

	var _constantsCardActionsTypes = __webpack_require__(372);

	var ActionTypes = _interopRequireWildcard(_constantsCardActionsTypes);

	var _utilsCreateReducerJs = __webpack_require__(379);

	var _utilsCreateReducerJs2 = _interopRequireDefault(_utilsCreateReducerJs);

	var cardActions = (_cardActions = {}, _defineProperty(_cardActions, ActionTypes.SELECT_CARD, function (state, action) {
	  return state.map(function (card) {
	    return card.id === action.id ? (0, _reactAddonsUpdate2['default'])(card, { selected: { $apply: function $apply(selected) {
	          return !selected;
	        } } }) : card;
	  });
	}), _defineProperty(_cardActions, ActionTypes.CHOOSE_CARD, function (state, action) {
	  return state.map(function (card) {
	    return card.id === action.id ? (0, _reactAddonsUpdate2['default'])(card, { choosed: { $set: true } }) : (0, _reactAddonsUpdate2['default'])(card, { choosed: { $set: false } });
	  });
	}), _cardActions);

	exports['default'] = (0, _utilsCreateReducerJs2['default'])([], cardActions);
	module.exports = exports['default'];
